package com.crawler.otomoto.ui;
...
import com.crawler.otomoto.MessageBoxExceptionHandler;
...
import com.crawler.otomoto.data.Province;
import com.crawler.otomoto.data.beans.DealerItem;
import com.crawler.otomoto.export.OtoMotoXlsExporterException;
				...
				try {
					...
					Thread t = new Thread() {
						public void run() {
							...
							} catch (OtoMotoXlsExporterException e) {
								MessageBoxExceptionHandler.handle(e, AppPanel.this);
							}
