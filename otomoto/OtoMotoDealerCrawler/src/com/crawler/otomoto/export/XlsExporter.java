...
public class XlsExporter {
	...
	public void export(File file, List<DealerItem> dealers, String provinceName, LogPanel logger) throws OtoMotoXlsExporterException {
	...
	private void exportAsSingleFile(File file, List<DealerItem> dealers, String provinceName) throws OtoMotoXlsExporterException {
		try {
			File xlsFile = new File(file.getAbsolutePath());
			if (xlsFile.exists()) {
			...
			throw new OtoMotoXlsExporterException("Wystąpił problem podczas tworzenia pliku. Otwórz program w konsoli i sprawdź logi", e);
		} catch (WriteException e) {
			throw new OtoMotoXlsExporterException("Wystąpił problem podczas zapisu do pliku xls. Otwórz program w konsoli i sprawdź logi", e);
		}
	}
	...
	private void createHeader(WritableSheet sheet) throws OtoMotoXlsExporterException {
		...
		try {
			...
			throw new OtoMotoXlsExporterException("Wystąpił problem podczas tworzenia naglowka pliku xls. Otwórz program w konsoli i sprawdź logi", e);
		}
		...
		try {
			...
			throw new OtoMotoXlsExporterException("Został przekroczony maksymalny rozmiar pliku xls 65536 wierszy", e);
		} catch (WriteException e) {
			throw new OtoMotoXlsExporterException("Wystąpił problem podczas zapisu danych do pliku xls. Otwórz program w konsoli i sprawdź logi", e);
		}
	}
